...
function Alert({message,successFunc,dismissFunc}) {
  return (
    ...
    <div className="flex">
      <button type="button" onClick={()=>{successFunc()}} className="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-xs px-3 py-1.5 me-2 text-center inline-flex items-center dark:bg-gray-600 dark:hover:bg-gray-500 dark:focus:ring-gray-800">
        Go Ahead
      </button>
